  ...
  return (
    <>
      <nav className=" bg-blend-color-dodge bg-zinc-800 text-white  flex flex-col justify-center items-center">
        <div className="md:flex md:flex-col items-center justify-center  gap-10 sm:flex sm:flex-col xs:flex flex-col lg:flex lg:flex-col my-2 lg:items-center">
          ...
          <div className="my-10">@copy2025 Randylon. All Rights Reserved</div>
        </div>
      </nav>
    </>
  );
